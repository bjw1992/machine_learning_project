...
if __name__ == "__main__":
    ...
    #unit_tests.graphtest('house_votes_84.data')
    #unit_tests.testID3AndEvaluate()
    #mini_grader()

    #unit_tests.testPruningOnHouseData('test2.csv')

    #data = parse.parse('googleplaystore.csv')

    unit_tests.testPruningOnHouseData('googleplaystore.csv')
    #a=parse('googleplaystore.csv')
